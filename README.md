...
**Time for time** — én række pr. time i stedet for et vandret bånd. Temperaturen får en tone på en divergerende skala (kold blå ↔ neutral ↔ varm rød) forankret absolut om 15 °C, så 20 ° altid har samme farve uanset hvilken dag man ser på; tonen ligger bag tallet, aldrig i tallet, så kontrasten er sikker uanset trin. Nedbøren tegnes i to lag i samme bane: den lyse bredde er sandsynligheden (0–100 %), den mættede bjælke i bunden er mængden, skaleret med kvadratroden så en let byge stadig er synlig ved siden af et skybrud. Timer med nedbør får en blå kant, nattetimer en svag tone. Listen viser 12 timer med en knap til hele vinduet, og oversigtsgrafen øverst fylder bredden uden vandret scroll.
